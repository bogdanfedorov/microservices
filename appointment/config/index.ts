...
export const DoctorsApiURL = process.env.APPOINTMENT_API_URL || 'http://localhost:4001'
export const ManagerApiURL = process.env.APPOINTMENT_API_URL || 'http://localhost:4003'
